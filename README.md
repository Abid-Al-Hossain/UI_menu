# UI Foundry Menu Studio

Standalone visual Menu generator built with Next.js, React, and TypeScript.

Standalone Menu component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Menu UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Menu generator
...
The editor is focused on controls that are native to Menu and useful in real product work:
- items, groups, icons, shortcuts, separators, disabled/active/selected states, and compact mode
- surface, spacing, typography, hover, focus, active, radius, border, and shadow
- context, sidebar, command, settings, and action menu variants
- menu/list semantics depending on usage intent
- React export for menu structure

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Menu.
...
This repo is intended to publish as Abid-Al-Hossain/UI_menu.
