...
export default function Page() {
  const [state, setState] = useState<MenuState>(DEFAULT_MENU_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Menu Studio" controls={controls} preview={output} /></AppShell>;
}
